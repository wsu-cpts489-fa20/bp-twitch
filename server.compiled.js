    ...
    return _regeneratorRuntime["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log("User authenticated through Twitch! In passport callback."); //Our convention is to build userId from displayName and provider

            console.log(profile);
            userId = profile.id;
            return _context.abrupt("return", done(null, userId));
...
app.get('/users/:userId', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime["default"].mark(function _callee2(req, res, next) {
    var thisUser;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            return _context2.abrupt("return", res.status(404).send("No user account with id " + req.params.userId + " was found in database."));

          case 9:
            return _context2.abrupt("return", res.status(200).json(JSON.stringify(thisUser)));
          ...
          case 12:
            ...
            console.log();
            return _context2.abrupt("return", res.status(400).send("Unexpected error occurred when looking up user with id " + req.params.userId + " in database: " + _context2.t0));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return _context3.abrupt("return", res.status(400).send("/users POST request formulated incorrectly. " + "It must contain 'password','displayName','profilePicURL','securityQuestion' and 'securityAnswer fields in message body."));
          ...
          case 13:
            thisUser = _context3.sent;
            return _context3.abrupt("return", res.status(201).send("New account for '" + req.params.userId + "' successfully created."));
          ...
          case 17:
            ...
            return _context3.abrupt("return", res.status(400).send("Unexpected error occurred when adding or looking up user in database. " + _context3.t0));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return _context4.abrupt("return", res.status(400).send("users/ PUT request formulated incorrectly." + "It must contain 'userId' as parameter."));

          case 3:
            validProps = ['password', 'displayName', 'profilePicURL', 'securityQuestion', 'securityAnswer'];
            _context4.t0 = _regeneratorRuntime["default"].keys(req.body);
          ...
          case 5:
            ...
            return _context4.abrupt("return", res.status(400).send("users/ PUT request formulated incorrectly." + "Only the following props are allowed in body: " + "'password', 'displayname', 'profilePicURL', 'securityQuestion', 'securityAnswer'"));
          ...
          case 18:
            ...
            res.status(400).send("Unexpected error occurred when updating user data in database: " + _context4.t2);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 4:
            ...
            return _context5.abrupt("return", res.status(404).send("No user account " + req.params.userId + " was found. Account could not be deleted."));

          case 9:
            return _context5.abrupt("return", res.status(200).send("User account " + req.params.userId + " was successfully deleted."));
          ...
          case 12:
            ...
            console.log();
            return _context5.abrupt("return", res.status(400).send("Unexpected error occurred when attempting to delete user account with id " + req.params.userId + ": " + _context5.t0));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return _context6.abrupt("return", res.status(400).send("POST request on /rounds formulated incorrectly." + "Body must contain all 8 required fields: date, course, type, holes, strokes, " + "minutes, seconds, notes."));
          ...
          case 10:
            ...
            return _context6.abrupt("return", res.status(400).send("Unexpected error occurred when adding round" + " to database: " + _context6.t0));
    ...
    return _regeneratorRuntime["default"].wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 9:
            return _context7.abrupt("return", res.status(200).json(JSON.stringify(thisUser.rounds)));
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            _context8.t0 = _regeneratorRuntime["default"].keys(bodyObj);
          ...
          case 6:
            ...
            return _context8.abrupt("return", res.status(400).send("rounds/ PUT request formulated incorrectly." + "It includes " + bodyProp + ". However, only the following props are allowed: " + "'date', 'course', 'type', 'holes', 'strokes', " + "'minutes', 'seconds', 'notes'"));
          ...
          case 23:
            ...
            return _context8.abrupt("return", res.status(400).send("Unexpected error occurred when updating round in database: " + _context8.t2));
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 8:
            ...
            return _context9.abrupt("return", res.status(400).send("Unexpected error occurred when deleting round from database: " + _context9.t0));
